...
#你可以使用sticky选项去指定对齐方式，可以选择的值有：N/S/E/W，分别代表上/下/左/右。如果你想让label靠左显示，你可以设置stricky的值为W。
    ...
    def loadImage(self):
        ...
        self.w2=int(self.w0/wh_ratio)
        self.h2=int(self.h0/wh_ratio)
        ...
        if os.path.exists(self.labelfilename):
            with open(self.labelfilename) as f:
                for (i, line) in enumerate(f):
                    ...
                    tx0 = int(tmp[0] * self.w2)
                    ty0 = int(tmp[1] * self.h2)

                    tx1 = int(tmp[2] * self.w2)
                    ty1 = int(tmp[3] * self.h2)
    ...
    def mouseClick(self, event):
        if self.STATE['click'] == 0:
            ...
            x1, x2 = x1/self.w2, x2 /self.w2;
            y1, y2 = y1 /self.h2,y2 /self.h2;
