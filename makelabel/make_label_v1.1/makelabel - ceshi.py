...
#你可以使用sticky选项去指定对齐方式，可以选择的值有：N/S/E/W，分别代表上/下/左/右。如果你想让label靠左显示，你可以设置stricky的值为W。
        ...
        self.mainPanel = Canvas(self.frame1,width=900,height=500, cursor='tcross')
...
#####################################################################################        
        ...
        self.mainPanel.bind("<MouseWheel>",processWheel) #加上滑动的滚轴的大小
...
#        self.mainPanel.grid(row=1, column=1, rowspan=5, sticky=W + N)
    ...
    def loadImage(self):
        ...
        self.w2=int(self.w0/wh_ratio)  #原始图片的长
        self.h2=int(self.h0/wh_ratio)  #原始图片的高
